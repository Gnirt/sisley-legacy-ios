//
//  MomAddDaughterViewController.m
//  Sisley
//
...
@interface MomAddDaughterViewController ()

@end

@implementation MomAddDaughterViewController
...
- (IBAction)registrationMom:(id)sender {
    ...
    user[@"user_type"] = @"daughter";
    user[@"firstname"] = self.firstnameTextField.text;
    user[@"lastname"] = self.lastnameTextField.text;
    
    [user signUpInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
        if (!error) {
            DaughterHairPickViewController *DaughterHairPick = [[DaughterHairPickViewController alloc] initWithNibName:nil bundle:nil];
            [self presentViewController:DaughterHairPick animated:YES completion:nil];
...
{
    if ([sender isEqual:self.emailTextField] || [sender isEqual:self.emailTextField])
    {
